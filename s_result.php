...
if(isset($_POST['submit']))
{
	...
	$sql="SELECT * FROM `student_data` WHERE  `u_class`='$class' AND `u_rollno`='$rollno' AND `u_mothername`='$mothername'";
    $sql2="SELECT * FROM `user_marks` WHERE `u_class`='$class' AND `u_rollno`='$rollno' AND `u_mothername`='$mothername'";
